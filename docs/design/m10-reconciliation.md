...
| R-series ontology document | Link semantics; do not duplicate | `docs/design/embodiment-and-weave.md`, the protocol implementation, published vectors, and the canary receipt describe the Cluster boundary. Matrix remains the eventual identity authority. |
